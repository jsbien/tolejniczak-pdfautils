...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__pdfaimg

#else
#  define SWIG_init    init_pdfaimg

#endif
#define SWIG_name    "_pdfaimg"
...
SWIGINTERN PyObject *_wrap_getImage(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  char **arg1 = (char **) 0 ;
  int *arg2 = (int *) 0 ;
  char *arg3 = (char *) 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOOO:getImage",&obj0,&obj1,&obj2,&obj3,&obj4)) SWIG_fail;
  res3 = SWIG_AsCharPtrAndSize(obj0, &buf3, NULL, &alloc3);
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "getImage" "', argument " "3"" of type '" "char const *""'");
  }
  arg3 = (char *)(buf3);
  ecode4 = SWIG_AsVal_int(obj1, &val4);
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "getImage" "', argument " "4"" of type '" "int""'");
  } 
  arg4 = (int)(val4);
  ecode5 = SWIG_AsVal_int(obj2, &val5);
  if (!SWIG_IsOK(ecode5)) {
    SWIG_exception_fail(SWIG_ArgError(ecode5), "in method '" "getImage" "', argument " "5"" of type '" "int""'");
  } 
  arg5 = (int)(val5);
  ecode6 = SWIG_AsVal_bool(obj3, &val6);
  if (!SWIG_IsOK(ecode6)) {
    SWIG_exception_fail(SWIG_ArgError(ecode6), "in method '" "getImage" "', argument " "6"" of type '" "bool""'");
  } 
  arg6 = (bool)(val6);
  ecode7 = SWIG_AsVal_int(obj4, &val7);
  if (!SWIG_IsOK(ecode7)) {
    SWIG_exception_fail(SWIG_ArgError(ecode7), "in method '" "getImage" "', argument " "7"" of type '" "int""'");
  } 
  arg7 = (int)(val7);
  getImage(arg1,arg2,(char const *)arg3,arg4,arg5,arg6,arg7);
  resultobj = SWIG_Py_Void();
  if (*arg1) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"getImage", _wrap_getImage, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
